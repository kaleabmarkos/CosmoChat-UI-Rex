...
// import UseMessage from "../../components/UserMessag";
// import useMediaQuery from "@mui/material/useMediaQu";
...
//     const handleScroll = () => {
//         const scrollPosision = window.scrollY;
//     };
...
//             try{
//                 const response = await api.patch(`session/${id}/`, updatedSession);
//                 setSessions(
//                     sessions.map((session) =>
...
//         const compeletion = await openai.chat.compeletion.create({
//             messages: [
//                 {
//                     role: "system",
//                     content:
