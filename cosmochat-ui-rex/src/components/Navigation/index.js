...
Grid: A responsive layout component that arranges its children in a grid structure.
  ...
  item: Defines the individual grid items within the container.
  style: Inline styles for the Grid component.
  {...AllStyles.navigationBar}, {...AllStyles.navigationLeft}, {...AllStyles.navigationName}, {...AllStyles.navigationRight}: Spread operator to apply custom styles from AllStyles.
...
Link: A component for creating navigable links.
  href: The destination URL.

Typography: A component for displaying text with different styles.

Menu: A component for creating dropdown menus.
  id: A unique identifier for the menu.
  anchorEl: The element that the menu is anchored to.
  keepMounted: Keeps the menu in the DOM when closed, improving performance.
  open: Controls the open/close state of the menu.
  onClose: Event handler for menu close actions.

MenuItem: Represents an individual item in a Menu.
  onClick: Event handler for menu item click actions.

Divider: A horizontal line used to separate content.
  Commonly used in menus to separate different sections.
