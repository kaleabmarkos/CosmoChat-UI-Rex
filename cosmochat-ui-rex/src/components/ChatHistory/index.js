...
/*
Grid: The Grid component is a container for laying out elements in a grid system. It supports various props like container, item, xs, justifyContent, alignItems, etc., which help in defining the layout structure.
Button: The Button component is a clickable button element with several styling options like variant, aria-describedby, and event handlers like onClick.
Dialog: The Dialog component is used for displaying modal dialogs. It has props like open to control visibility and event handlers like onClose.
DialogActions: The DialogActions component is a container for actions (buttons) within a dialog.
DialogContent: The DialogContent component is used to display the content area of a dialog.
DialogContentText: The DialogContentText component is a typography component for displaying text content within a dialog.
DialogTitle: The DialogTitle component is used to display the title of a dialog.

Grid: A responsive layout component that arranges its children in a grid structure.
  container: Defines the outer grid container.
  item: If true, the component will have the flex item behavior. We should be wrapping items with a container.
  style: Inline styles for the Grid component.

Button: A customizable button component.
  aria-controls: Indicates the ID of the element that the button controls (e.g., a menu).
  aria-haspopup: Indicates if the button has a popup menu.
  onClick: Event handler for button click actions.

Dialog: A modal dialog component for displaying content over the main application.
  open: Controls the open/close state of the dialog.
  onClose: Event handler for dialog close actions.
  aria-labelledby: Accessibility attribute to associate the dialog with a label.
  aria-describedby: Accessibility attribute to associate the dialog with a description.
  
DialogActions: A container for action buttons in a Dialog.

DialogContent: The main content area of a Dialog.

DialogContentText: Text content within a Dialog.

DialogTitle: The title of a Dialog.
*/
